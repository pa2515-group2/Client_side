...
public class Edit_appointment extends JFrame{
	...
	public Edit_appointment() {
		...
		radioButton.setBounds(30, 198, 164, 23);
		getContentPane().add(radioButton);
		radioButton.setActionCommand("0900");
		
		final JRadioButton radioButton_1 = new JRadioButton("10:00");
		radioButton_1.setBounds(160, 198, 164, 23);
		getContentPane().add(radioButton_1);
		radioButton_1.setActionCommand("1000");
...
//		radioButton_3.setActionCommand("12:00");
		...
		radioButton_4.setBounds(30, 224, 164, 23);
		getContentPane().add(radioButton_4);
		radioButton_4.setActionCommand("1300");
		
		final JRadioButton radioButton_5 = new JRadioButton("14:00");
		radioButton_5.setBounds(160, 224, 164, 23);
		getContentPane().add(radioButton_5);
		radioButton_5.setActionCommand("1400");
...
//				comboBldGrp.setSelectedIndex(1);
		...
		btnReturn.setBounds(274, 277, 89, 23);
...
//							|| description.equals("")
						...
						if (radioButton.isSelected())
							obj.put("datetimeslot", day+radioButton.getActionCommand());
						else if (radioButton_1.isSelected())
							obj.put("datetimeslot",
									day+radioButton_1.getActionCommand());
...
//									radioButton_3.getActionCommand());
							...
							obj.put("datetimeslot",
									day+radioButton_4.getActionCommand());
						else if (radioButton_5.isSelected())
							obj.put("datetimeslot",
									day+radioButton_5.getActionCommand());
...
//									radioButton_9.getActionCommand());
						...
						sc.deleteData(ServerCode.URL_PREFIX+"appointment/"+
								doctorID+"/"+obj.get("datetimeslot")+"/"+patientID);
						sc.PostData(obj, ServerCode.URL_PREFIX+"appointment","Edit_appointment","Manager");
					}
				}
