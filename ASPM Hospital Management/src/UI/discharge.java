...
//							"dd/MM/yyyy");
					...
					if (in == null || out == null || dis == null || desc.getText().equals("")
						...
						throw new RuntimeException();
							...
							System.out.println(ServerCode.URL_PREFIX+"discharge/"+obj.get("doctorid")
									+"/"+obj.get("patientid"));
							sc.PostData(obj,
									ServerCode.URL_PREFIX+"discharge/"+obj.get("doctorid")
									+"/"+obj.get("patientid"),
									"discharge","Manager");
					}
				}
		...
		btnReset.setBounds(164, 243, 89, 23);
...
//		jBtnReturn.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
		...
		jBtnReturn.setBounds(306, 243, 89, 22);
//		btnSubmit.setBounds(10, 243, 89, 23);
